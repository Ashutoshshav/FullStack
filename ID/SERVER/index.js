...
const { handleScheduleEmailAndEntry } = require("./Controllers/ReminderController")
...
app.use(cors({
    origin: ["http://108.181.168.113:51838", "http://192.168.0.252:5000", "http://localhost:5000", "http://localhost:5174"], // Allowed origins
